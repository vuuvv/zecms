...
namespace vuuvv.data
{
    ...
    public sealed class NHibernateSessionManager
    {
        ...
        public static string path = "App_Data/cms.db";
        ...
        private NHibernateSessionManager()
        {
            ...
            if (IsInWebContext())
            {
                file = HttpContext.Current.Server.MapPath(path);
            }
            if (!File.Exists(file))
            {
                CreateSchema();
        ...
        private void Mappings(MappingConfiguration m)
        {
        ...
        private FluentConfiguration BuildConfiguration()
        {
            string file = path;
            if (IsInWebContext())
            {
            ...
            return Fluently.Configure()
                .Database(SQLiteConfiguration.Standard.UsingFile(file))
                .Mappings(Mappings);
        }
        ...
        {
            BuildConfiguration().ExposeConfiguration(BuildSchema).BuildConfiguration();
        }
